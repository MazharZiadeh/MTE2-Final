...
int main() {
    ...
    BufferManager::EBO EBO1(indicesCube1, sizeof(indicesCube1));
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        VAO1.Bind();
        glDrawElements(GL_TRIANGLES, sizeof(indicesCube1) / sizeof(int), GL_UNSIGNED_INT, 0);

        // Unbind VAO for the main cube
        VAO1.Unbind();
        ...
        for (auto& particle : particles) {
            ...
            glm::mat4 particleModel = glm::translate(glm::mat4(1.0), particle.getPosition())
                * glm::scale(glm::mat4(0.05f), glm::vec3(0.05f)); // Adjust scale as needed
